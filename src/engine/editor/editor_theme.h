...
namespace hob::editor_theme {
    ...
    constexpr ImVec4 COLOR_BG_POPUP{0.071f, 0.071f, 0.071f, 1.0f};
    ...
    constexpr ImVec4 COLOR_CLEAR = COLOR_BG_DARK;
    ...
    constexpr ImVec2 MENU_TITLE_INSET{3.0f, -3.0f};
    constexpr float MENU_TITLE_SPACING_X = 14.0f;
