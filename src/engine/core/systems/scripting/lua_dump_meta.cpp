...
namespace hob {
    ...
    void LuaScriptSystem::dump_asset_names_meta() {
        ...
        out << "-- Source of truth: `DefineX.Foo = { ... }` assignments throughout the project.\n";
    ...
    void LuaScriptSystem::dump_entity_registry_meta() {
        ...
        const bool ok = write_name_registry_meta(out_path,
                                                 ...
                                                 "`DefineEntity.Foo = { ... }` assignments throughout the project.",
                                                 names);
    ...
    void LuaScriptSystem::dump_component_registry_meta() {
        ...
        const bool ok = write_name_registry_meta(out_path,
                                                 ...
                                                 "`DefineComponent.Foo = { ... }` assignments throughout the project.",
                                                 names);
    ...
    void LuaScriptSystem::dump_scene_registry_meta() {
        ...
        const bool ok = write_name_registry_meta(out_path,
                                                 ...
                                                 "`DefineScene.Foo = { ... }` assignments throughout the project.",
                                                 names);
